// ======================================================================
// DAQArrayInterrupt.v generated from TopDesign.cysch
// 03/30/2020 at 16:39
...
module top ;
    ...
    CyControlReg_v1_80 Marker1Drive (
        .control_1(Net_45),
        .control_2(Net_46),
        .control_3(Net_47),
        .control_0(Net_48),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Marker1Drive.Bit0Mode = 0;
    defparam Marker1Drive.Bit1Mode = 0;
    defparam Marker1Drive.Bit2Mode = 0;
    defparam Marker1Drive.Bit3Mode = 0;
    defparam Marker1Drive.Bit4Mode = 0;
    defparam Marker1Drive.Bit5Mode = 0;
    defparam Marker1Drive.Bit6Mode = 0;
    defparam Marker1Drive.Bit7Mode = 0;
    defparam Marker1Drive.BitValue = 0;
    defparam Marker1Drive.BusDisplay = 0;
    defparam Marker1Drive.ExtrReset = 0;
    defparam Marker1Drive.NumOutputs = 1;

	wire [0:0] tmpOE__Marker1_net;
	wire [0:0] tmpFB_0__Marker1_net;
	wire [0:0] tmpIO_0__Marker1_net;
	wire [0:0] tmpINTERRUPT_0__Marker1_net;
	electrical [0:0] tmpSIOVREF__Marker1_net;

	cy_psoc3_pins_v1_10
		#(.id("073e0352-68b6-477d-a3a2-442ec0090b23"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Marker1
		 (.oe(tmpOE__Marker1_net),
		  .y({Net_48}),
		  .fb({tmpFB_0__Marker1_net[0:0]}),
		  .io({tmpIO_0__Marker1_net[0:0]}),
		  .siovref(tmpSIOVREF__Marker1_net),
		  .interrupt({tmpINTERRUPT_0__Marker1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Marker1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
