// ======================================================================
// Interrupt_Priority.v generated from TopDesign.cysch
// 04/21/2020 at 18:30
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("3b38f82f-b54e-4182-a957-29dc06ac37e3/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("3b38f82f-b54e-4182-a957-29dc06ac37e3/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
    ...
    CyControlReg_v1_80 LED_Drive (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LED_Drive.Bit0Mode = 0;
    defparam LED_Drive.Bit1Mode = 0;
    defparam LED_Drive.Bit2Mode = 0;
    defparam LED_Drive.Bit3Mode = 0;
    defparam LED_Drive.Bit4Mode = 0;
    defparam LED_Drive.Bit5Mode = 0;
    defparam LED_Drive.Bit6Mode = 0;
    defparam LED_Drive.Bit7Mode = 0;
    defparam LED_Drive.BitValue = 0;
    defparam LED_Drive.BusDisplay = 0;
    defparam LED_Drive.ExtrReset = 0;
    defparam LED_Drive.NumOutputs = 1;
    ...
    CyControlReg_v1_80 Marker2 (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Marker2.Bit0Mode = 0;
    defparam Marker2.Bit1Mode = 0;
    defparam Marker2.Bit2Mode = 0;
    defparam Marker2.Bit3Mode = 0;
    defparam Marker2.Bit4Mode = 0;
    defparam Marker2.Bit5Mode = 0;
    defparam Marker2.Bit6Mode = 0;
    defparam Marker2.Bit7Mode = 0;
    defparam Marker2.BitValue = 0;
    defparam Marker2.BusDisplay = 0;
    defparam Marker2.ExtrReset = 0;
    defparam Marker2.NumOutputs = 1;

	wire [0:0] tmpOE__Marker2_Pin_net;
	wire [0:0] tmpFB_0__Marker2_Pin_net;
	wire [0:0] tmpIO_0__Marker2_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Marker2_Pin_net;
	electrical [0:0] tmpSIOVREF__Marker2_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("43fdedb4-12a8-49b6-8470-19371c066716"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Marker2_Pin
		 (.oe(tmpOE__Marker2_Pin_net),
		  .y({Net_42}),
		  .fb({tmpFB_0__Marker2_Pin_net[0:0]}),
		  .io({tmpIO_0__Marker2_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Marker2_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Marker2_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Marker2_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
