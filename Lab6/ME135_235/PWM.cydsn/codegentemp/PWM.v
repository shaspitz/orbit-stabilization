...
module top ;
	...
	cy_clock_v1_0
		#(.id("c0fd918e-cde2-4fc4-bb00-6ebeaa30a3cd"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__MoorPWM_net;
	wire [0:0] tmpFB_0__MoorPWM_net;
	wire [0:0] tmpIO_0__MoorPWM_net;
	wire [0:0] tmpINTERRUPT_0__MoorPWM_net;
	electrical [0:0] tmpSIOVREF__MoorPWM_net;
	...
	cy_psoc3_pins_v1_10
		...
		MoorPWM
		 (.oe(tmpOE__MoorPWM_net),
		  .y({Net_26}),
		  .fb({tmpFB_0__MoorPWM_net[0:0]}),
		  .io({tmpIO_0__MoorPWM_net[0:0]}),
		  .siovref(tmpSIOVREF__MoorPWM_net),
		  .interrupt({tmpINTERRUPT_0__MoorPWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MoorPWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_57 = ~Net_26;
    ...
    CyControlReg_v1_80 DirControl (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam DirControl.Bit0Mode = 0;
    defparam DirControl.Bit1Mode = 0;
    defparam DirControl.Bit2Mode = 0;
    defparam DirControl.Bit3Mode = 0;
    defparam DirControl.Bit4Mode = 0;
    defparam DirControl.Bit5Mode = 0;
    defparam DirControl.Bit6Mode = 0;
    defparam DirControl.Bit7Mode = 0;
    defparam DirControl.BitValue = 0;
    defparam DirControl.BusDisplay = 0;
    defparam DirControl.ExtrReset = 0;
    defparam DirControl.NumOutputs = 1;

	wire [0:0] tmpOE__MOtorDir_net;
	wire [0:0] tmpFB_0__MOtorDir_net;
	wire [0:0] tmpIO_0__MOtorDir_net;
	wire [0:0] tmpINTERRUPT_0__MOtorDir_net;
	electrical [0:0] tmpSIOVREF__MOtorDir_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("73dfad85-e81c-44c5-a020-147a9e4256b4"),
		  ...
		  .input_buffer_sel(2'b00))
		MOtorDir
		 (.oe(tmpOE__MOtorDir_net),
		  .y({Net_74}),
		  .fb({tmpFB_0__MOtorDir_net[0:0]}),
		  .io({tmpIO_0__MOtorDir_net[0:0]}),
		  .siovref(tmpSIOVREF__MOtorDir_net),
		  .interrupt({tmpINTERRUPT_0__MOtorDir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOtorDir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam TimerReset.BitValue = 0;
