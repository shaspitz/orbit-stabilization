...
#define BS_UDB_1_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x480002A4u)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000324u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000338u)
