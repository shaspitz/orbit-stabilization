...
uint32 Timer2_ReadPeriod(void) 
{
   ...
   #else
       return (CY_GET_REG24(Timer2_PERIOD_LSB_PTR));
   #endif /* (Timer2_UsingFixedFunction) */
}
...
void Timer2_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG24(Timer2_PERIOD_LSB_PTR, period);
...
uint32 Timer2_ReadCapture(void) 
{
   ...
   #else
       return (CY_GET_REG24(Timer2_CAPTURE_LSB_PTR));
   #endif /* (Timer2_UsingFixedFunction) */
}
...
void Timer2_WriteCounter(uint32 counter) 
{
    ...
    #else
        CY_SET_REG24(Timer2_COUNTER_LSB_PTR, counter);
